  ...
  return (
    <main className="auth-signal min-h-screen px-5 py-6 text-[#123c3a]">
      <nav className="mx-auto flex max-w-7xl items-center justify-between">
        <Link
          href="/"
          className="font-signal text-2xl font-black tracking-[-0.08em] transition hover:text-[#6bbf22]"
        >
          CareerLaunch
        </Link>
        <Link
          href="/register"
          className="rounded-full px-4 py-2 text-sm font-black transition hover:bg-[#123c3a] hover:text-[#b9ff66]"
        >
          Create account
        </Link>
      </nav>

      <section className="mx-auto grid min-h-[calc(100vh-76px)] max-w-7xl items-start gap-10 py-10 lg:grid-cols-[1fr_460px] lg:py-0">
        <div className="hidden max-w-3xl lg:block">
          ...
          <p className="mt-7 max-w-xl text-lg font-medium leading-8 text-[#4b4b4b]">
            Continue the same saved drafts, score checks, preview state, and
            export flow you already have.
          </p>
        </div>
        ...
        <section className="rounded-[28px] border border-[#123c3a]/10 bg-white p-6 shadow-[0_28px_70px_rgba(18,60,58,0.12)] sm:p-8">
          ...
          >
            ...
            <div className="flex items-center justify-end">
              <Link
                ...
                className="text-xs font-black text-[#4b4b4b] underline underline-offset-2 transition hover:text-[#123c3a]"
              >
                Forgot password?
              </Link>
            </div>
            <button
              className="signal-button-dark w-full justify-center"
              type="submit"
          ...
          <Link
            href="/register"
            className="signal-button-light mt-3 w-full justify-center"
          >
            Create account
          </Link>
        </section>
