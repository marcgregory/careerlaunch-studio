  ...
  <head>
    ...
    <style>
      ...
      * { box-sizing: border-box; }
      ...
      .summary { margin: 10px 0 0; color: #33343b; font-size: 12px; font-weight: 500; line-height: 1.65; }
      ...
      .split { display: grid; grid-template-columns: 1fr 0.85fr; gap: 28px; margin-top: 24px; break-inside: avoid; }
